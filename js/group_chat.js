...
function generateGroupSystemPrompt(group) {
    ...
    prompt += `   - \`[${group.me.nickname}的语音：...]\`, \`[${group.me.nickname}发来的照片/视频：...]\` / \`[...发来的照片：...]\` / \`[...发来的视频：...]\`: 我发送了特殊类型的消息，群成员可以对此发表评论。\n`;
...
- **普通消息**: \`[{成员真名}的消息：{消息内容}]\``;
    ...
    outputFormats += `
- **语音**: \`[{成员真名}的语音：{语音转述的文字}]\`
- **照片/视频**: \`[{成员真名}发来的照片/视频：{内容描述}]\` 或 \`[{成员真名}发来的照片：{内容描述}]\` 或 \`[{成员真名}发来的视频：{内容描述}]\`
